...
<body>
  ...
  <input type="hidden" id="cids" value="${cid_result}">
    ...
    <section id="team" class="team section-bg">
      ...
      <!-- 
        <div class="section-header">        
         ...
         -->
        <h1 style="text-align: center; color:#1bb1dc; font-weight:bold;">이미지 검색결과</h1>
		<br>
		<br>
		<br>
		<br>
  ...
  <script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var cids = $("input#cids").val();
		var flag = $("input#flag").val();
		if (flag == 0){
			alert("강아지가 있는 사진을 넣어주세요!");
		}
		else if(flag == 1){
			alert("비슷한 강아지가 없습니다.");
		}
